...
You also have to create an `Export Configuration` for Android. Refer to the https://github.com/godot-sdk-integrations/godot-play-game-services#export-configuration[README] of the repository.
